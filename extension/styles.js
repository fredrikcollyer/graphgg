...
(function() {
  ...
  colors: {
    ...
    positiveColor: '#81C784',    // Green for positive values
    negativeColor: '#E57373',    // Red for negative values
    originalLineColor: '#64B5F6', // Blue for original data lines
    adjustedLineColor: '#81C784', // Green for adjusted data lines
  },
  ...
  ui: {
    ...
    getBrandTextStyle: function(isSmall = false) {
      ...
      return {
        ...
        fontWeight: 'bold',
        fontSize: isSmall ? styles.typography.smallBrandTextSize : styles.typography.brandTextSize,
        letterSpacing: '0.5px',
